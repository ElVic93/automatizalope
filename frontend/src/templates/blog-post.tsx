...
const BlogPostTemplate: React.FC<BlogPostTemplateProps> = ({ pageContext }) => {
  ...
  const post = pageContext.mockData;
    ...
    >
      <Container>
        <article className="max-w-3xl mx-auto py-12">
            ...
            <Card variant="bordered" className="bg-[var(--color-gray-lightest)]">
              <Card.Body>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg">Escrito por {post.author?.name}</h3>
          ...
          {/* Related Posts (to be implemented when Strapi is connected) */}
          <div className="mt-12">
            <h2 className="text-2xl font-bold mb-6">Artículos relacionados</h2>
            <p className="text-[var(--color-text-secondary)]">
              Esta sección mostrará artículos relacionados cuando se integre con Strapi.
            </p>
          </div>

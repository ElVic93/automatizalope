...
export const mockProcessSteps: ProcessStep[] = [
  {
    id: '1',
    title: 'Diagnóstico',
    description: 'Analizamos tus procesos actuales para identificar oportunidades de automatización y mejora.',
    imageUrl: '/images/process/diagnosis.jpg',
    order: 1
  },
  {
    id: '2',
    title: 'Diseño de Solución',
    description: 'Creamos un plan detallado de la solución, considerando tus objetivos de negocio y recursos disponibles.',
    imageUrl: '/images/process/design.jpg',
    order: 2
  },
  {
    id: '3',
    title: 'Implementación',
    description: 'Desarrollamos e implementamos la solución de forma iterativa, asegurando una transición suave.',
    imageUrl: '/images/process/implementation.jpg',
    order: 3
  },
  {
    id: '4',
    title: 'Capacitación',
    description: 'Entrenamos a tu equipo para garantizar una adopción exitosa de las nuevas soluciones.',
    imageUrl: '/images/process/training.jpg',
    order: 4
  },
  {
    id: '5',
    title: 'Soporte y Mejora Continua',
    description: 'Brindamos soporte constante y evaluamos oportunidades de mejora para seguir optimizando tu negocio.',
    imageUrl: '/images/process/support.jpg',
    order: 5
  }
];
